...
docker compose exec rescuedogs pnpm test src/services/messaging/group

# E2E tests for group workflows
docker compose exec rescuedogs pnpm exec playwright test tests/e2e/messaging/group
