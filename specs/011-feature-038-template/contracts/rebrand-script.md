...
| 0    | Success                                                    |
| 1    | Invalid arguments                                          |
| 2    | Re-rebrand scenario (no RescueDogs found), user declined |
| 3    | Git not installed or not a git repo                        |

## Output Format

```
Rebranding RescueDogs → MyApp
Owner: myuser
...
Renaming files...
  ✓ RescueDogsLogo.tsx → MyAppLogo.tsx
  ✓ LayeredRescueDogsLogo.tsx → LayeredMyAppLogo.tsx
...
If grep finds 0 occurrences of "RescueDogs":

```
WARNING: This repository appears to have been rebranded already.
No "RescueDogs" references found.
