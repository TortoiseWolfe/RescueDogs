...
- [ ] CHK005 - Are all case variations to replace documented (RescueDogs, rescuedogs, SCRIPTHAMMER)? [Completeness, Spec §FR-002]
...
- [ ] CHK046 - Is behavior defined for binary files that might contain "RescueDogs"? [Edge Case, Gap]
