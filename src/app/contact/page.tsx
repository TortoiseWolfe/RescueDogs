...
export const metadata: Metadata = {
  title: 'Contact Us | Raised Paws',
  description:
    "Get in touch with the Raised Paws team. We'd love to hear from you!",
  keywords: ['contact', 'support', 'help', 'feedback', 'Raised Paws'],
  openGraph: {
    title: 'Contact Us | Raised Paws',
    description: 'Get in touch with the Raised Paws team',
    type: 'website',
  },
};
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a
                  href="https://github.com/TortoiseWolfe/RescueDogs/issues"
                ...
                <a
                  href="https://github.com/TortoiseWolfe/RescueDogs/discussions"
                  className="link link-primary flex items-center"
                  target="_blank"
                  rel="noopener noreferrer"
                >
