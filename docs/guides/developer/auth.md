...
Comprehensive guide to implementing authentication in RescueDogs using Supabase Auth.
...
RescueDogs uses Supabase Auth (GoTrue) for authentication. Since the app is a static export, all auth happens client-side with Supabase handling the backend.
