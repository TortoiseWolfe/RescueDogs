...
We take the security of RescueDogs seriously. If you believe you have found a security vulnerability in RescueDogs, please report it to us as described below.
...
- Email us at security@rescuedogs.com
...
When using RescueDogs in production, we recommend:
...
RescueDogs includes several built-in security features:
...
- Security Email: security@rescuedogs.com
- Project Maintainers: See CONTRIBUTING.md

## Acknowledgments

We appreciate the security research community's efforts in helping keep RescueDogs and our users safe. Responsible disclosure of vulnerabilities helps us ensure the security and privacy of our users.
