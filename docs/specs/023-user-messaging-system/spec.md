...
- React 19.1.0 (already in RescueDogs)
...
- Vitest (unit tests) - already in RescueDogs
- Playwright (E2E tests) - already in RescueDogs
- Pa11y (accessibility) - already in RescueDogs
