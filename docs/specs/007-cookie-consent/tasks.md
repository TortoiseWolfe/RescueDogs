...
docker compose exec rescuedogs pnpm test src/utils/consent
docker compose exec rescuedogs pnpm test src/contexts/Consent
docker compose exec rescuedogs pnpm test src/components/privacy

# Run integration tests
docker compose exec rescuedogs pnpm test src/tests/consent
