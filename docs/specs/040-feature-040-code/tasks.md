...
```
Command: docker compose exec rescuedogs pnpm test
...
```
Command: docker compose exec rescuedogs pnpm test --coverage src/lib/logger/
...
```
Command: docker compose exec rescuedogs pnpm run build
