...
**Constitution File**: `.specify/memory/constitution.md` (RescueDogs Constitution v1.0.1 - 6 core principles)
...
docker compose exec rescuedogs pnpm test src/components/atomic/AvatarUpload
