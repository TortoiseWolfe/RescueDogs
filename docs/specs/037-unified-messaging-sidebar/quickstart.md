...
- Docker running with RescueDogs container
...
docker compose exec rescuedogs pnpm test ConnectionManager
docker compose exec rescuedogs pnpm test UnifiedSidebar
