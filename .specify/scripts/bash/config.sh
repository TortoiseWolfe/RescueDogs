#!/usr/bin/env bash
# RescueDogs SpecKit harness config — sourced by every bash helper in this dir.
#
# Why this file exists: RescueDogs keeps specs under `features/<category>/<NNN-name>/`
...
# RescueDogs:      features/foundation/004-foo/spec.md
