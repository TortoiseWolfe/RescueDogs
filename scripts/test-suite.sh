...
# Test Suite Runner for RescueDogs
...
echo ""
echo -e "${BLUE}${BOLD}╔══════════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}${BOLD}║                  RescueDogs Comprehensive Test Suite               ║${NC}"
echo -e "${BLUE}${BOLD}╚══════════════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if in_docker; then
    ...
    CMD_PREFIX="docker compose exec rescuedogs"
fi
...
if ! in_docker; then
    ...
    docker compose restart rescuedogs > /dev/null 2>&1
