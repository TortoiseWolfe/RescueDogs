...
const RETIMED_AT = Date.parse(
  // First day RescueDogs ships retention (#237). Override via RETENTION_RETIMED_AT
  // if the window is deliberately reset later.
  process.env.RETENTION_RETIMED_AT ?? '2026-09-06T00:00:00Z'
);
