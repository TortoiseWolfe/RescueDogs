...
if ! docker compose ps rescuedogs | grep -q "Up"; then
    echo "❌ Error: Docker container 'rescuedogs' is not running"
...
echo ""
echo "Run E2E tests:"
echo "  docker compose exec rescuedogs pnpm exec playwright test tests/e2e/messaging/"
echo ""
